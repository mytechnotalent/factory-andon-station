#!/usr/bin/env python3
"""Generate the factory-andon-station.png banner (1500x1500, stdlib).
...
def _draw_features(banner, colors) -> None:
    ...
    None
    """
    banner.text("FACTORY_ANDON_SYSTEM", 5, colors["cyan"],
                banner.W // 2, 750)
    banner.text("TOWER LIGHT  DIVERTER", 4, colors["silver"],
                banner.W // 2, 900)
...
def main() -> int:
    ...
    out = Path(__file__).resolve().parent.parent / "factory-andon-station.png"
    banner.save(out)
